...
let incBtn = document.querySelector(".next-btn");
let decBtn = document.querySelector(".prev-btn");
let shflBtn = document.querySelector(".random-btn");
...
shflBtn.addEventListener("click", function () {
